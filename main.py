...
# Vérifiez si le symbole donné a gagné le jeu en vérifiant toutes les combinaisons gagnantes possibles
...
root = Tk()
# Créez l'application de jeu Morpion et démarrez la boucle principale
